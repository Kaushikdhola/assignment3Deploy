import "./chunk-NFXWUQG4.js";
import {
  isPlatformServer
} from "./chunk-2UDDC5CI.js";
import "./chunk-6WERV6D7.js";
import {
  FirebaseApp
} from "./chunk-4LHCCKW3.js";
import {
  FIREBASE_APP_NAME,
  FIREBASE_OPTIONS,
  ɵapplyMixins,
  ...
  ɵfirebaseAppFactory,
  ɵlazySDKProxy
} from "./chunk-XT4GMWBI.js";
import {
  firebase
} from "./chunk-KDBEOVIF.js";
import {
  VERSION,
...
var AngularFireAuth = class _AngularFireAuth {
  ...
  constructor(options, name2, platformId, zone, schedulers, useEmulator, settings, tenantId, languageCode, useDeviceLanguage, persistence, _appCheckInstances) {
    ...
    const auth = of(void 0).pipe(observeOn(schedulers.outsideAngular), switchMap(() => zone.runOutsideAngular(() => import("./index.esm-KINWYKHN.js"))), map(() => ɵfirebaseAppFactory(options, zone, name2)), map((app) => ɵauthFactory(app, zone, useEmulator, tenantId, languageCode, useDeviceLanguage, settings, persistence)), shareReplay({
      bufferSize: 1,
      refCount: false
    }));
